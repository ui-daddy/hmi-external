import { SplitifyComponent } from './components/Splitify-external/Splitify-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, SplitifyComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, SplitifyComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
