import { CoolGameComponent } from './components/cool-game-external/cool-game-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, CoolGameComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, CoolGameComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
