import { BuildingBlockComponent } from './components/building-block-external/building-block-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, BuildingBlockComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, BuildingBlockComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
