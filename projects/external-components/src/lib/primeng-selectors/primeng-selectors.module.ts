import { TestAppDataComponent } from './components/Test-app-data-external/Test-app-data-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, TestAppDataComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, TestAppDataComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
