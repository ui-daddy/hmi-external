import { TestProject57Component } from './components/Test-Project-57-external/Test-Project-57-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, TestProject57Component],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, TestProject57Component],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
