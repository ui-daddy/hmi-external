import { EmiCalculatorComponent } from './components/Emi-Calculator-external/Emi-Calculator-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, EmiCalculatorComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, EmiCalculatorComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
