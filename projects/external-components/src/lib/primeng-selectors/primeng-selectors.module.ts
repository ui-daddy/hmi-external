import { NotificationTesterComponent } from './components/notification-tester-external/notification-tester-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, NotificationTesterComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, NotificationTesterComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
