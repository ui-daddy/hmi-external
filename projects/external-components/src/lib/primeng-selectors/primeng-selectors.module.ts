import { TicTacToeComponent } from './components/tic-tac-toe-external/tic-tac-toe-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, TicTacToeComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, TicTacToeComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
