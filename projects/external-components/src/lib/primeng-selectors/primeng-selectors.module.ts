import { RemindersComponent } from './components/Reminders-external/Reminders-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, RemindersComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, RemindersComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
