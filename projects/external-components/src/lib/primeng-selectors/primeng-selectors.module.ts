import { ConsoleComponent } from './components/console-external/console-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, ConsoleComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, ConsoleComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
