import { LoginPageComponent } from './components/login-page-external/login-page-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, LoginPageComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, LoginPageComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
